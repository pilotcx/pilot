...
export default function TaskDetailPage() {
  ...
  const [updateTaskStatus, { loading: updatingStatus }] = useApi(api.updateTask);
    ...
    <div className="container max-w-3xl">
      <div className="mb-6">
        ...
        <div className="flex gap-2 items-center mt-2">
          ...
          <Badge className={cn("text-xs", getStatusBadgeClass(task.status as TaskStatus))}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-foreground">{getFormattedDate(task.dueDate as string)}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-foreground">
                  {assignee ? assignee.user.fullName : 'Unassigned'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <Badge variant="secondary" className={cn("mt-1", getPriorityColor(task.priority as TaskPriority))}>
              ...
              <div>
                ...
                <div className="text-foreground">
                  {task.status === TaskStatus.Completed ? 'Completed' : 
                   ...
                   task.status === TaskStatus.Pending ? 'To Do' : 'Overdue'}
                </div>
              </div>
            </div>
          </div>
